...
const Home =()=>{
    ...
    return(
        <div>
            ...
            <CardPages query={"https://e-commerce-wvh2-qw50sstcd-88sahils-projects.vercel.app/api/v1/item/getAllitems?fields=_id,price,title,coverphoto,discount&limit=10&page=1"} />
            <Features />
        </div>
    )
}
