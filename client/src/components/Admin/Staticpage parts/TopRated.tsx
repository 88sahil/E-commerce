...
const TopRated = () => {
    ...
    const getItems =async():Promise<void>=>{
        try{
            let respone = await axios.get(`https://e-commerce-wvh2-qw50sstcd-88sahils-projects.vercel.app/api/v1/item/getAllitems?AverageRating[gt]=0&sort=-AverageRating,-NoofRating&limit=${limit}&fields=title,coverphoto,AverageRating,NoofRating`,{withCredentials:true})
            if(respone.data){
