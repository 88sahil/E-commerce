...
const PieData = () => {
    ...
    const getData = async():Promise<void>=>{
        try{
            let response = await axios.get(`https://e-commerce-wvh2-qw50sstcd-88sahils-projects.vercel.app/api/v1/Orders/propstatics?bytype=${type}&year=${year}`,{withCredentials:true})
            if(response.data){
