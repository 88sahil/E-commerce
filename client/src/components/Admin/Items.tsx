...
const Items = () => {
    ...
    const getProducts = async():Promise<void>=>{
        let query = `https://mpfserver.vercel.app/api/v1/item/getAllitems?page=${page}&limit=10&sort="-publishedAt"&fields=_id,price,title,coverphoto,discount`
        try{
            setloader(true)
    ...
    <main className='flex flex-col items-center'>
         <div className='w-[900px] max-md:w-full p-2'>
            ...
            <div className="mt-2 w-full justify-center p-2">
                        <Pagination onChange={(e,page)=>{e;setpage(page)}}  count={totalproducts/1>1? (totalproducts/10):(1)}/>
            </div>
        </div>
