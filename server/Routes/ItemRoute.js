...
const {AddItem,UploadPhoto,Update, uploadphotos, removephoto, getAllItem, deleteitem, getItem, getlisting, UpdateCoverPhoto} = require('../Controllers/ItemController')
...
ItemRoute.route('/updateCoverphoto/:id').patch(protected,uploader,UpdateCoverPhoto)
